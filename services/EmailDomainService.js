...
class EmailDomainService extends BaseService {
    ...
    constructor() {
        ...
        this.userService = new UserService(null, { AuthService });
        this.clientService = new ClientService();
        this.entityName = 'EmailDomain';
        this.listingFields = ["id", "domain", "-_id", "isVerified"];
        this.updatableFields = ["name", "domain", "description", "dnsRecords", "isVerified", "mailgunRouteId"];
    }
    ...
    async createEmailDomain(emailDomainData) {
        try {
            ...
            await mg.domains.create(mgData, (error, body) => {
                if (error) {
                ...
                return this.create(emailDomainDbData)
            })
